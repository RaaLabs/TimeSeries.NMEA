...
namespace RaaLabs.Edge.Connectors.NMEA
{
    ...
    /// </summary>
    public class UnsupportedSentenceException : Exception
    {
        /// <summary>
        /// Initializes a new instance of <see cref="UnsupportedSentenceException"/>
        /// </summary>
        ...
        public UnsupportedSentenceException(string sentence, string talker, string identifier) 
